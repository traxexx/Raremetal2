...
class annoGroups
{
  public:
	...
	void LoadCovFile(String &cov_file_name, int _adjust, int _marker_col, int _cov_col, int _sampleSize, bool load_all = false);
  ...
  private:
	...
	void loadCovStrings(String &cov_file_name, bool load_all);
